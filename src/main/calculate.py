...
from stress_test.bender_rw import read_bender_output, parse_path, \
        read_synopsis, read_energies, parse_input 
from stress_test.strain import u 
import numpy as np
from stress_test.deform_energies import deform_energies
from numpy.lib.function_base import meshgrid
from os.path import exists
from os import makedirs
from stress_test.plots import plot_consts_proxm, plot_energies, plot_amplitude
...
def study_consts_proximity(in_file):
    ...
    plot_consts_proxm(mesh_x, mesh_A, E_b_mat, E_s_mat, folder, acc)
